 ...
 */
package com.speakeasy.skyengine.resources.io.lzma;

import com.speakeasy.skyengine.resources.io.lzma.ICodeProgress;
import com.speakeasy.skyengine.resources.io.lzma.rangecoder.BitTreeEncoder;
...
public class Encoder {
    ...
    class LiteralEncoder {
        ...
        class Encoder2 {
            ...
            public void init() {
                com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(m_Encoders);
            }

            public void encode(com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder rangeEncoder, byte symbol) throws IOException {
                int context = 1;
                for (int i = 7; i >= 0; i--) {
                    int bit = ((symbol >> i) & 1);
            ...
            public void encodeMatched(com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder rangeEncoder, byte matchByte, byte symbol) throws IOException {
                int context = 1;
                boolean same = true;
                for (int i = 7; i >= 0; i--) {
                    int bit = ((symbol >> i) & 1);
            ...
            public int getPrice(boolean matchMode, byte matchByte, byte symbol) {
                ...
                if (matchMode) {
                    for (; i >= 0; i--) {
                        int matchBit = (matchByte >> i) & 1;
                        int bit = (symbol >> i) & 1;
                        price += com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice(m_Encoders[((1 + matchBit) << 8) + context], bit);
                        context = (context << 1) | bit;
                        if (matchBit != bit) {
                            i--;
                            break;
                ...
                for (; i >= 0; i--) {
                    int bit = (symbol >> i) & 1;
                    price += com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice(m_Encoders[context], bit);
                    context = (context << 1) | bit;
                }
                return price;
            }
    ...
    class LenEncoder {
        ...
        public void init(int numPosStates) {
            com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_choice);
        ...
        public void encode(com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder rangeEncoder, int symbol, int posState) throws IOException {
        ...
        public void setPrices(int posState, int numSymbols, int[] prices, int st) {
            int a0 = com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_choice[0]);
            int a1 = com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_choice[0]);
            int b0 = a1 + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_choice[1]);
            int b1 = a1 + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_choice[1]);
            int i;
    ...
    com.speakeasy.skyengine.resources.io.lzma.lz.BinTree _matchFinder = null;
    com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder _rangeEncoder = new com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder();
    ...
    void create() {
        if (_matchFinder == null) {
            ...
            com.speakeasy.skyengine.resources.io.lzma.lz.BinTree bt = new com.speakeasy.skyengine.resources.io.lzma.lz.BinTree(numHashBytes);
            _matchFinder = bt;
        }
    ...
    void init() {
        ...
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_isMatch);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_isRep0Long);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_isRep);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_isRepG0);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_isRepG1);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_isRepG2);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.initBitModels(_posEncoders);
    ...
    int getRepLen1Price(int state, int posState) {
        return com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isRepG0[state])
                + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
    }

    int getPureRepPrice(int repIndex, int state, int posState) {
        int price;
        if (repIndex == 0) {
            price = com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isRepG0[state]);
            price += com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
        } else {
            price = com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isRepG0[state]);
            if (repIndex == 1) {
                price += com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isRepG1[state]);
            } else {
                price += com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isRepG1[state]);
                price += com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice(_isRepG2[state], repIndex - 2);
            }
        }
        return price;
    }
    ...
    int getOptimum(int position) throws IOException {
        ...
        _optimum[1].Price = com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState])
                + _literalEncoder.getSubCoder(position, _previousByte).getPrice(!Base.stateIsCharState(_state), matchByte, currentByte);
        _optimum[1].makeAsChar();

        int matchPrice = com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]);
        int repMatchPrice = matchPrice + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isRep[_state]);
        ...
        int normalMatchPrice = matchPrice + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isRep[_state]);
        ...
        while (true) {
            ...
            int curAnd1Price = curPrice
                    + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState])
            ...
            matchPrice = curPrice + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
            repMatchPrice = matchPrice + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isRep[state]);
            ...
            if (!nextIsChar && matchByte != currentByte) {
                ...
                if (lenTest2 >= 2) {
                    ...
                    int nextRepMatchPrice = curAnd1Price
                            + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext])
                            + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isRep[state2]);
                    {
                ...
                if (lenTest < numAvailableBytesFull) {
                    ...
                    if (lenTest2 >= 2) {
                        ...
                        int curAndLenCharPrice
                                ...
                                + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext])
                        ...
                        int nextMatchPrice = curAndLenCharPrice + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]);
                        int nextRepMatchPrice = nextMatchPrice + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice1(_isRep[state2]);
            ...
            if (newLen >= startLen) {
                normalMatchPrice = matchPrice + com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.getPrice0(_isRep[state]);
    ...
    void fillDistancesPrices() {
        ...
        for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++) {
            ...
            for (posSlot = Base.kEndPosModelIndex; posSlot < _distTableSize; posSlot++) {
                _posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << com.speakeasy.skyengine.resources.io.lzma.rangecoder.Encoder.kNumBitPriceShiftBits);
            }
