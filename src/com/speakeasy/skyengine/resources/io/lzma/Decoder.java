...
import com.speakeasy.skyengine.resources.io.lzma.lz.OutWindow;
import com.speakeasy.skyengine.resources.io.lzma.rangecoder.BitTreeDecoder;
...
public class Decoder {
    ...
    class LenDecoder {
        ...
        public void init() {
            com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_Choice);
        ...
        public int decode(com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder rangeDecoder, int posState) throws IOException {
    ...
    class LiteralDecoder {
        ...
        class Decoder2 {
            ...
            public void init() {
                com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_Decoders);
            }

            public byte decodeNormal(com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder rangeDecoder) throws IOException {
                int symbol = 1;
                do {
            ...
            public byte decodeWithMatchByte(com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder rangeDecoder, byte matchByte) throws IOException {
                int symbol = 1;
                do {
    ...
    private final com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder m_RangeDecoder = new com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder();
    ...
    void init() throws IOException {
        ...
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_IsMatchDecoders);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_IsRep0LongDecoders);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_IsRepDecoders);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_IsRepG0Decoders);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_IsRepG1Decoders);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_IsRepG2Decoders);
        com.speakeasy.skyengine.resources.io.lzma.rangecoder.Decoder.initBitModels(m_PosDecoders);
