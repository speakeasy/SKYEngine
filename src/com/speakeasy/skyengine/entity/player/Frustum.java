...
public class Frustum {
    ...
    private static FloatBuffer fbProjection = BufferUtils.createFloatBuffer(16);
    private static FloatBuffer fbModelview = BufferUtils.createFloatBuffer(16);
